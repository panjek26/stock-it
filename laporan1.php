					...
					<div class="panel-body">
						<table data-toggle="table" data-url="tables/data1.json"  data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="false" data-sort-name="name" data-sort-order="asc">
						    ...
						    <tr>
								...
								<th data-field="stok" data-sortable="true">Stok Barang</th>
...
//---------------------------------------------- INSERT TABLE ------------------------------------------------------
							...
							{
								$sqlbarang="select b.id_barang, b.nama_barang,b.satuan, g.id_gudang, g.nama_gudang,p.stok from barang b, gudang g, posisi p where (b.id_barang=p.id_barang) and (g.id_gudang=p.id_gudang) order by b.nama_barang asc";				
