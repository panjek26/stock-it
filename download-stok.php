...
{
		$sql="select b.id_barang, b.nama_barang,b.satuan, g.nama_gudang, p.stok from barang b, gudang g, posisi p where (b.id_barang=p.id_barang) and (g.id_gudang=p.id_gudang) order by b.nama_barang asc";				
