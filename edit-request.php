			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="col-md-6">
							<form role="form" action="save-request.php?mode=edit" method="post">
								<?php
//-----------------------------------------GET DATA BARANG---------------------------------------------------------

								$id=$_GET['id'];
								$sqlreq="select * from request where id_request='$id'";
								$qrreq=mysqli_query($con,$sqlreq);
								$dtreq=mysqli_fetch_array($qrreq);	
								$usr=$dtreq['username'];
								
								$sqlcari=mysqli_query($con,"select * from user where username='$usr'");
								...
								<div class="form-group">
									...
									<input class="form-control" name="tgl" value="'.$dtreq['tgl_request'].'" readonly>
								</div>
								<div class="form-group">
									<label>User</label>
									<input class="form-control" name="user" value="'.$dtreq['username'].' ('.$level.')" readonly>
								</div>
								...
								<div class="form-group">
									...
									<textarea class="form-control" name="ket" rows="8">'.$dtreq['keterangan'].'</textarea>
								</div>';
