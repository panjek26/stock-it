		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">Stok keluar bulan <?php echo date("M Y"); ?></div>
					<div class="panel-body">
						<table data-toggle="table" data-url="tables/data1.json"  data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="tgl" data-sort-order="desc">
							...
							<?php
//---------------------------------------------- INSERT TABLE ------------------------------------------------------
							$sqltrx="select t.id_transaksi,t.kd_toko,t.tanggal_do,t.jenis_transaksi,t.id_barang,t.jumlah,t.keterangan,b.nama_barang,b.satuan from transaksi t, barang b where (t.id_barang=b.id_barang) and (month(t.tanggal_do)=month(now())) and (t.jenis_transaksi='Keluar') order by t.id_transaksi desc";				
