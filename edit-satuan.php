			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="col-md-6">
							<form role="form" action="save-satuan.php?mode=edit" method="post">
								<?php
//-----------------------------------------GET DATA BARANG---------------------------------------------------------

								$id=antiInjections($con,$_GET['id']);
								$sqlsat="select * from satuan where id_satuan='$id'";
								$qrsat=mysqli_query($con,$sqlsat);
								$dtsat=mysqli_fetch_array($qrsat);							
								echo '
								<input type="hidden" name="id" value="'.$id.'">
								<div class="form-group">
									<label>Nama Satuan</label>
									<input class="form-control" name="nama" value="'.$dtsat['nama_satuan'].'">
								</div>';
