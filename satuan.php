		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading"><a href="add-satuan.php" class="btn btn-primary btn-md">Add Items</a></div>
					<div class="panel-body">
						<table data-toggle="table" data-url="tables/data1.json"  data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="false" data-sort-name="name" data-sort-order="asc">
						    ...
						    <tr>
								...
								-->
						        <th data-field="name"  data-sortable="true">Nama Satuan</th>
							...
							<?php
//---------------------------------------------- INSERT TABLE ------------------------------------------------------
							$sqlsatuan="select * from satuan order by nama_satuan asc";				
							$querysatuan=mysqli_query($con,$sqlsatuan);
							while ($datasatuan=mysqli_fetch_array($querysatuan))
							{
							echo '
							<tr>
						        <td data-field="name"  data-sortable="true">'.$datasatuan['nama_satuan'].'</td>
								<td data-field="action" data-sortable="true"><a href="edit-satuan.php?id='.$datasatuan['id_satuan'].'"><span class="glyphicon glyphicon-pencil" title="Edit"></a> &nbsp;&nbsp;<a href="save-satuan.php?id='.$datasatuan['id_satuan'].'&mode=delete"><span class="glyphicon glyphicon-remove" title="Delete"></span></a></td>
						    </tr>';
							}
//---------------------------------------------- INSERT TABLE ------------------------------------------------------							
							?>
