...
//---------------------------------------------- INSERT TABLE ------------------------------------------------------
							...
							if(substr($_SESSION['level'],0,6)=='gudang')
							{
								...
								$sqlbarang="select b.id_barang, b.nama_barang,b.satuan, g.id_gudang, g.nama_gudang,p.stok from barang b, gudang g, posisi p where (b.id_barang=p.id_barang) and (g.id_gudang=p.id_gudang) and (p.id_gudang='$idgudang') order by b.nama_barang asc";				
							
							}
							else
							{
								$sqlbarang="select b.id_barang, b.nama_barang,b.satuan, coalesce(sum(p.stok),0) as jumlah from barang b left join posisi p on b.id_barang=p.id_barang
...
//---------------------------------------------- INSERT TABLE ------------------------------------------------------							
					...
					<div class="panel-body"><span class="glyphicon glyphicon-download-alt"></span> <a href="download-out-stok.php">Download Excel</a></div>
				</div>
			</div>
		</div><!--/.row-->	
		<!--
