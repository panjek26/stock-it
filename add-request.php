...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Form Request</h1>
			</div>
		</div><!--/.row-->
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="col-md-6">
							<form role="form" action="save-request.php?mode=add" method="post">
								<?php
								...
								<div class="form-group">
									<label>Tanggal</label>
									<input class="form-control" name="tgl" value="<?php echo $tgl; ?>" readonly>
								</div>		
								<div class="form-group">
									<label>Detail Request</label>
									<textarea class="form-control" name="ket" rows="8">Nama Barang |  Jumlah </textarea>
								</div>
