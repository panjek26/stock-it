			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="col-md-6">
							<form role="form" action="save-gudang.php?mode=add" method="post">

								<div class="form-group">
									<label>Kode Gudang</label>&nbsp; <font color="red">(awali dengan kata gudang)</font>
									<input class="form-control" name="kode" value="gudang-">
								</div>
